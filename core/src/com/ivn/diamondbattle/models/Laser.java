...
public class Laser {
    ...
    private CameraManager lt = CameraManager.get();
    public Sprite begin1,begin2,mid1,mid2,end1,end2;

    public Laser(){
        // LASER
        // TODO HACER SPRITESHEET
        begin1 = new Sprite(tbegin1);
        begin2 =  new Sprite(tbegin2);
        mid1 =  new Sprite(tmid1);
        mid2 = new Sprite(tmid2);
        end1 = new Sprite(tend1);
        end2 =  new Sprite(tend2);
    }
